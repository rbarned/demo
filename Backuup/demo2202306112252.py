...
class Digit:
    ...
    def setadd(self, initialValue, initialResult):
        ...
        self.gearM.keyframe_insert("rotation_euler", frame=self.currentFrame)
        self.gearR.rotation_euler[2]     = radians(initialValue*36)
        self.gearR.keyframe_insert("rotation_euler", frame=self.currentFrame)
        self.cylinder2.rotation_euler[2] = radians(initialValue*36)+radians(-18)
        self.cylinder2.keyframe_insert("rotation_euler", frame=self.currentFrame)
        return True

clean_scene()
print('This is Robert')
bpy.data.scenes["Scene"].frame_end = 85
